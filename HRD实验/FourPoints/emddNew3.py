...
def get_training_data(data_set):
    if data_set == "fake":
        ...
        training_data = MatlabTrainingData('/mnt/X500/farmers/wangxw/shenzhen/starfish/HRD/all_scaler.csv', load_csv_data)
    elif data_set == "musk1":
...
if __name__ == "__main__":
    ...
    if prediction_result_n.accuracy >0 and prediction_result_n.precision > 0 and prediction_result_n.recall > 0:
